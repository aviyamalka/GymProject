...
namespace GymProject.Controllers
{
    public class TrainingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TrainingId,Name,Description,VideoUrl")] Training training)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrainingId,Name,Description,VideoUrl")] Training training)
        {
